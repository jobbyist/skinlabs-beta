...
import { Eye, EyeOff, Chrome, Apple, ArrowLeft, CheckCircle } from "lucide-react";
...
export function AuthModal({ isOpen, onClose, initialMode = 'register', onAuthSuccess }: AuthModalProps) {
  ...
  const profileMutation = useMutation({
    mutationFn: async (data: SkinProfileData) => {
      const response = await apiRequest('/api/user/skin-profile', {
        method: 'POST',
        body: JSON.stringify(data),
        headers: {
          ...
          <>
            ...
            <div className="space-y-6">
              ...
              <Alert className="border-primary/20 bg-primary/5">
                ...
                <AlertDescription>
                  <span className="font-medium text-primary">Founding Member Perks:</span> 
                  The first 1000 members get lifetime free access to all premium features!
                </AlertDescription>
              </Alert>
